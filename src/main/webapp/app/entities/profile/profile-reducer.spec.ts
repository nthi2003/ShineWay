...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './profile.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFILE actions', async () => {
      const arg = { id: '5ac8ab7a-123d-4318-b51e-b9301878a25d' };
    ...
    it('dispatches UPDATE_PROFILE actions', async () => {
      const arg = { id: '5ac8ab7a-123d-4318-b51e-b9301878a25d' };
    ...
    it('dispatches PARTIAL_UPDATE_PROFILE actions', async () => {
      const arg = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
    ...
    it('dispatches DELETE_PROFILE actions', async () => {
      const arg = 42666;
