            ...
            <tbody>
              {profileList.map((profile, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{profile.phone}</td>
                  <td>{profile.email}</td>
                  <td>{profile.dob ? <TextFormat type="date" value={profile.dob} format={APP_DATE_FORMAT} /> : null}</td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/profile/${profile.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
