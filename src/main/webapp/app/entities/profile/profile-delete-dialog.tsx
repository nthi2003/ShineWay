...
import { deleteEntity, getEntity } from './profile.reducer';
...
export const ProfileDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/profile${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="shineWayApp.profile.delete.question">Are you sure you want to delete Profile {profileEntity.id}?</ModalBody>
      <ModalFooter>
