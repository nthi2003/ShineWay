...
public class UserPermissionResource {
    ...
    public UserPermissionResource(UserPermissionService userPermissionService, UserPermissionQueryService userPermissionQueryService) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<Page<UserPermissionDTO>> getAllUserPermissions(UserPermissionCriteria criteria, Pageable pageable) {
