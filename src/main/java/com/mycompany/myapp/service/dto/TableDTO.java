...
public class TableDTO implements Serializable {
    ...
    public TableDTO(String id, String name, Integer capacity, Integer status, String area, Boolean isDeleted, Long createdBy, Long updatedBy, LocalDateTime createdDate, LocalDateTime updatedDate) {
        this.id = id;
        this.name = name;
