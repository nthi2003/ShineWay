...
public class UserPermissionService {
    ...
    public UserPermissionDTO createUserPermission(CreateUserPmDTO createDTO) {
        ...
        Permission permission = permissionRepository
            .findById(createDTO.getPermissionId())
    ...
    public void deleteUserPermission(String id) {
        userPermissionRepository.findById(id).orElseThrow(() -> new RuntimeException("UserPermission not found with id: " + id));
