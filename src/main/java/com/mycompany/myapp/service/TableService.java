...
public class TableService {
    ...
    public TableDTO getTableById(String id) {
        return tablesRepository.findByIdAndIsDeletedFalse(id)
    ...
    Tables table = tablesRepository.findByIdAndIsDeletedFalse(tableDTO.getId())
        .orElseThrow(() -> new RuntimeException("Table not found"));
    ...
    public void deleteTable(String id) {
        Tables tables = tablesRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new RuntimeException("Table not found"));
